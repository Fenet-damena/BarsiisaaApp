...
const wordsData = {
  english: {
    fruits: [
      ...
      { english: "Pineapple", oromo: "Paayinaappil", emoji: "🍍" },
      { english: "Strawberry", oromo: "Istaraaberii", emoji: "🍓" },
    ...
    colors: [
      ...
      { english: "Orange", oromo: "Burtukaana", emoji: "🟠" },
      { english: "Purple", oromo: "Diimaa halluu", emoji: "🟣" },
      { english: "Pink", oromo: "Piinkii", emoji: "🩷" },
      { english: "Brown", oromo: "Bunni", emoji: "🤎" },
    ...
    animals: [
      ...
      { english: "Elephant", oromo: "Carbaa", emoji: "🐘" },
      { english: "Monkey", oromo: "Jeelbii", emoji: "🐵" },
      { english: "Bird", oromo: "Simbirroo", emoji: "🐦" },
      { english: "Fish", oromo: "Qurxummii", emoji: "🐟" },
      { english: "Horse", oromo: "Fardaa", emoji: "🐴" },
      { english: "Cow", oromo: "Saawwaa", emoji: "🐄" },
