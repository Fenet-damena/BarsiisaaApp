...
const wordData = {
  english: [
    ...
    { word: "Pear", emoji: "🍐", category: "Fruit" },
    { word: "Cherry", emoji: "🍒", category: "Fruit" },
    { word: "Kiwi", emoji: "🥝", category: "Fruit" },
    { word: "Lemon", emoji: "🍋", category: "Fruit" },
    { word: "Avocado", emoji: "🥑", category: "Fruit" },
    { word: "Coconut", emoji: "🥥", category: "Fruit" },
    { word: "Green Apple", emoji: "🍏", category: "Fruit" },
    { word: "Tomato", emoji: "🍅", category: "Fruit" },
    // Animals
    ...
    { word: "Squirrel", emoji: "🐿️", category: "Animal" },
  ...
  oromo: [
    ...
    { word: "Paappaayyaa", emoji: "🍈", category: "Fuduraa" },
    { word: "Loomii", emoji: "🍋", category: "Fuduraa" },
    { word: "Harbuu", emoji: "🍉", category: "Fuduraa" },
    // Bineensa
    ...
    { word: "Hoolaa", emoji: "🐑", category: "Bineensa" },
    { word: "Re'ee", emoji: "🐐", category: "Bineensa" },
    { word: "Sa'a", emoji: "🐮", category: "Bineensa" },
    // Halluu
    ...
    { word: "Adii", emoji: "⚪", category: "Halluu" },
    { word: "Magaala", emoji: "🟤", category: "Halluu" },
    { word: "Daalacha", emoji: "🔘", category: "Halluu" },
  ]
};
