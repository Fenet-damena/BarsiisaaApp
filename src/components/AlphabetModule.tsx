...
const alphabetData: LetterData[] = [
  ...
  { letter: 'C', english: 'Cat', oromo: 'Cabbi', sound: 'see', oromoSound: 'chah' },
  ...
  { letter: 'H', english: 'House', oromo: 'Hoolaa', sound: 'aitch', oromoSound: 'hah' },
  ...
  { letter: 'Q', english: 'Queen', oromo: 'Qoccaa', sound: 'cue', oromoSound: 'Qah' },
  { letter: 'R', english: 'Rainbow', oromo: 'Raachaa', sound: 'ar', oromoSound: 'rah' },
  ...
  { letter: 'W', english: 'Water', oromo: 'Warabeessa', sound: 'double-you', oromoSound: 'wah' },
  { letter: 'X', english: 'Xylophone', oromo: 'Xalayaa', sound: 'eks', oromoSound: 'Tah' },
