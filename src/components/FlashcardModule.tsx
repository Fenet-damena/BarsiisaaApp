...
const flashcardData = {
  ...
  oromo: {
    2: [
      { english: "Apple", oromo: "Arba", emoji: "🍎", letter: "A", oromoLetterSound: "Ah" },
      { english: "Ball", oromo: "Buna", emoji: "⚽", letter: "B", oromoLetterSound: "Buh" },
      { english: "Cat", oromo: "Cabbi", emoji: "🐱", letter: "C", oromoLetterSound: "Cha" },
      { english: "Dog", oromo: "Damma", emoji: "🐶", letter: "D", oromoLetterSound: "Dah" },
      { english: "Elephant", oromo: "Eegee", emoji: "🐘", letter: "E", oromoLetterSound: "Eh" },
      { english: "Fish", oromo: "Farda", emoji: "🐟", letter: "F", oromoLetterSound: "Fah" },
      { english: "Giraffe", oromo: "Gurraacha", emoji: "🦒", letter: "G", oromoLetterSound: "Gah" },
      { english: "Hoola", oromo: "Hoola", emoji: "🐑", letter: "H", oromoLetterSound: "Hah" },
      { english: "Ice Cream", oromo: "Ilma", emoji: "🍦", letter: "I", oromoLetterSound: "Ee" },
      { english: "Juice", oromo: "Jaldeessa", emoji: "🧃", letter: "J", oromoLetterSound: "Jah" },
      { english: "Kite", oromo: "Kitaaba", emoji: "🪁", letter: "K", oromoLetterSound: "Kah" },
      { english: "Lion", oromo: "Loon", emoji: "🦁", letter: "L", oromoLetterSound: "Lah" },
      { english: "Moon", oromo: "Muka", emoji: "🌙", letter: "M", oromoLetterSound: "Mah" },
      { english: "Nest", oromo: "Nama", emoji: "🪹", letter: "N", oromoLetterSound: "Nah" },
      { english: "Orange", oromo: "Odaa", emoji: "🍊", letter: "O", oromoLetterSound: "Oh" },
      { english: "Pencil", oromo: "Pappayaa", emoji: "✏️", letter: "P", oromoLetterSound: "Pah" },
      { english: "Queen", oromo: "Qamalee", emoji: "👑", letter: "Q", oromoLetterSound: "Qah" },
      { english: "Rainbow", oromo: "Raachaa", emoji: "🌈", letter: "R", oromoLetterSound: "Rah" },
      { english: "Sun", oromo: "Saree", emoji: "☀️", letter: "S", oromoLetterSound: "Sah" },
      { english: "Tree", oromo: "Tokko", emoji: "🌳", letter: "T", oromoLetterSound: "Tah" },
      { english: "Umbrella", oromo: "Ulee", emoji: "☂️", letter: "U", oromoLetterSound: "Oo" },
      { english: "Violin", oromo: "Vayooliini", emoji: "🎻", letter: "V", oromoLetterSound: "Vah" },
      { english: "Water", oromo: "Waraabessa", emoji: "💧", letter: "W", oromoLetterSound: "Wah" },
      { english: "Xylophone", oromo: "Xalayaa", emoji: "🎶", letter: "X", oromoLetterSound: "Kha" },
      { english: "Yellow", oromo: "Yeeyyii", emoji: "🟡", letter: "Y", oromoLetterSound: "Yah" },
      { english: "Zebra", oromo: "Zeeroo", emoji: "🦓", letter: "Z", oromoLetterSound: "Zah" },
    ]
  }
};
